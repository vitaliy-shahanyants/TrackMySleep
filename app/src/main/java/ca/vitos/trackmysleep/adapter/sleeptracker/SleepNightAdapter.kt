package ca.vitos.trackmysleep.adapter.sleeptracker
...
import ca.vitos.trackmysleep.util.convertDurationToFormatted
import ca.vitos.trackmysleep.util.convertNumericQualityToString
...
class SleepNightAdapter: RecyclerView.Adapter<SleepNightAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SleepNightAdapter.ViewHolder, position: Int) {
        ...
        holder.qaulityImage.setImageResource(when (item.sleepQuality){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SleepNightAdapter.ViewHolder {
        ...
        val view = layoutInflater.inflate(R.layout.list_item_sleep_night,
            parent,false)
        Log.d("RecyclerView", "Data Lenght: ${data.size}" )
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        val qaulityImage: ImageView = itemView.findViewById(R.id.quality_image)
